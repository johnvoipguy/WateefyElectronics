<img src="../images/Node_Backbone.png" width="285" height="245">
<p align="center">
...
- **LED Outputs**: 8 channels configured (GPIO 0, 1, 2, 3, 15, 18, 16, 17)
...
3. Default LED pin is GPIO 0 (first of 8 channels)
...
- Connect: SCK/SD WS→not connected
