...
- **Watch your polarity on the input terminal.** It's best practice to always double-check + and – before powering up. The board has an ideal-diode circuit to protect against damage from a reversed input, and a Polarity LED that shows green (correct) or red (reversed) so you know at a glance.
...
See the **Troubleshooting** section of the full NODE Mini Guide, or reach out through the support link printed on the board silkscreen. *(Placeholder — insert your real support URL/QR destination here.)*
